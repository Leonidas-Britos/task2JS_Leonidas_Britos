...
// divCard.classList.add('divCardContenedora');
// let h3Div = document.createElement("h3");
// h3Div.innerText = "Titulo de ejemplo";
// h3Div.setAttribute('alt',texto);
// divCard.appendChild(h3Div);
// document.querySelector("div.cards_home").appendChild(divCard);
////////////////////////////////////////////////////////
...
tarjetaTitulo.innerText = "Titulo de ejemplo card";

let tarjetaTexto = document.createElement("p");
tarjetaTexto.classList.add('tarjeta-texto');
tarjetaTexto.innerText = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis sit ullam, ad totam aliquam quae adipisci nobis magnam vero quibusdam?";
...
tarjetaPrecio.innerText = "Price: $ejemplo"
